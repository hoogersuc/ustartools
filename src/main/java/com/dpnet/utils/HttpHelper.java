...
public final class HttpHelper {
    ...
    public static RequestResult doGet(String url) {
        return doGet(url, new HashMap<String, Object> (), new HashMap());
    }

    /**
     * 发送 GET 请求（HTTP）, K-V 形式, 无请求头参数
     */
    ...
    public static byte[] download(String url, Map<String, Object> params, Map<String, String> headers) {
        CloseableHttpClient httpClient = HttpClients.custom().setDefaultRequestConfig(requestConfig).build();
        HttpGet httpGet;
        HttpResponse response = null;
        RequestResult requestResult = new RequestResult();
    ...
    public static RequestResult doPost(String url) {
        return doPost(url, new HashMap<String, Object> (), new HashMap());
    }

    /**
     * 发送 POST 请求（HTTP），JSON 形式，无请求头参数
     */
    ...
    public static RequestResult doPost(String url, File file, Map<String, Object> params, Map<String, String> headers) {
        CloseableHttpClient httpClient = HttpClients.custom().setDefaultRequestConfig(requestConfig).build();
        RequestResult requestResult = new RequestResult();
        String httpStr = null;
        HttpPost httpPost = new HttpPost(url);
        ...
        try {
            ...
            httpPost.setConfig(requestConfig);
            httpPost = setHeadersToPost(httpPost, headers);
            httpPost.setEntity(getMutipartEntry(params, file));
            response = httpClient.execute(httpPost);
            if (response != null) {
                HttpEntity entity = response.getEntity();
                httpStr = EntityUtils.toString(entity, "UTF-8");
    ...
    public static RequestResult doPostSSL(String url, Map<String, Object> params, Map<String, String> headers) {
        ...
        try {
            ...
            //log.debug("doPostSSL: \nURL:{}, \nparams:{}, \nheaders:{}", url, JSONObject.toJSONString(params), headers);
